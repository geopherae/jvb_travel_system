...
<body class="font-poppins text-gray-800 overflow-hidden"
  ...
  <main class="ml-0 lg:ml-64 lg:mr-80 h-screen overflow-y-auto p-6 space-y-6 relative z-0">
    ...
    <!-- Packages Grid -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-full sm:max-w-3xl md:max-w-6xl">
      ...
      <a href="admin_tour_packages.php"
        ...
        <!-- Card Content -->
        <div class="p-4 sm:p-6 md:p-8 flex flex-col items-center text-center space-y-2 sm:space-y-4">
          
          <!-- Icon -->
          <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-sky-100 flex items-center justify-center group-hover:scale-110 transition-transform">
            <svg class="w-8 sm:w-10 h-8 sm:h-10 text-sky-500" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm3.5-9c.83 0 1.5-.67 1.5-1.5S16.33 8 15.5 8 14 8.67 14 9.5s.67 1.5 1.5 1.5zm-7 0c.83 0 1.5-.67 1.5-1.5S9.33 8 8.5 8 7 8.67 7 9.5 7.67 11 8.5 11zm3.5 6.5c2.33 0 4.31-1.46 5.11-3.5H6.89c.8 2.04 2.78 3.5 5.11 3.5z"/>
            </svg>
          </div>
          
          <!-- Title & Description -->
          <h2 class="text-lg sm:text-2xl font-bold text-sky-600">Tour Packages</h2>
          <p class="text-xs sm:text-sm text-gray-600">Create and manage custom travel experiences</p>
          
          <!-- Call to Action -->
          <div class="mt-2 sm:mt-4 px-4 sm:px-6 py-1.5 sm:py-2 bg-sky-100 text-sky-600 font-semibold text-xs sm:text-sm rounded-full group-hover:bg-sky-200 transition">
            Manage Tours
          </div>
        </div>
      ...
      <a href="../admin/admin_visa_packages.php"
        ...
        <div class="p-4 sm:p-6 md:p-8 flex flex-col items-center text-center space-y-2 sm:space-y-4">
          ...
          <!-- Icon -->
          <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-purple-100 flex items-center justify-center group-hover:scale-110 transition-transform">
            <svg class="w-8 sm:w-10 h-8 sm:h-10 text-purple-500" fill="currentColor" viewBox="0 0 24 24">
              <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/>
            </svg>
          </div>
          
          <!-- Title & Description -->
          <h2 class="text-lg sm:text-2xl font-bold text-purple-600">Visa Packages</h2>
          <p class="text-xs sm:text-sm text-gray-600">Handle visa applications and requirements</p>
          
          <!-- Call to Action -->
          <div class="mt-2 sm:mt-4 px-4 sm:px-6 py-1.5 sm:py-2 bg-purple-100 text-purple-600 font-semibold text-xs sm:text-sm rounded-full group-hover:bg-purple-200 transition">
            Manage Visas
          </div>
        </div>
