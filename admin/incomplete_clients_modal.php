...
?>
<div id="incomplete-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center" style="position:fixed;">
  <div class="absolute inset-0 bg-black/50" data-modal-dismiss="incomplete-modal" style="position:fixed;"></div>
  <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-xl mx-4 max-h-[80vh] overflow-hidden z-auto" style="position:relative;">
